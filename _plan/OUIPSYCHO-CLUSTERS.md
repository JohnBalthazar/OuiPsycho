...
- **7 satellites écrits**, tous `status: scheduled`, dates échelonnées du 2026-11-02 au 2026-11-20 : `tdah-femme-adulte`, `fonctions-executives`, `test-tdah-adulte-asrs` (quiz dépublié le 2026-09-04 : l'audit de provenance a établi que ses items paraphrasaient de trop près l'ASRS, une échelle protégée par des droits d'usage clinique, malgré l'intention initiale de ne s'inspirer que de ses thèmes — **consigne pour toute reprise** : construire les questions sur des vignettes comportementales originales, jamais sur la structure ou les items d'une échelle clinique nommée, même reformulés), `hpi-tdah-confusion-diagnostic` (quiz profils), `autisme-adulte-diagnostic-tardif`, `diagnostic-tdah-france`, `tdah-amenagements-travail-rqth`. 2 quiz créés.
